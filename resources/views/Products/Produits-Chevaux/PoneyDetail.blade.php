    ...
    @foreach($produits as $produit)
        ...
        <div class="detail-product">
            ...
            <div class="detail">
                ...
                <div class="titre">
                    <h1>Alimentation des Poneys</h1>
                    <p>Alf Sahel Respecte Toutes les normes alimentaires pour des Poneys en bonne santé ... <br>
                    un véterinaire  spécialisé vache indique soigneusement les éléments nutritifs dont les Poneys avons besoin</p>
                </div>
