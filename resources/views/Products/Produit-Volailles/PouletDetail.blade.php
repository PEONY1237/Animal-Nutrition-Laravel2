    ...
    @foreach($produits as $produit)
        ...
        <div class="detail-product">
            ...
            <div class="detail">
                ...
                <div class="titre">
                    <h1>Alimentation des Poulets</h1>
                    <p>Alf Sahel Respecte Toutes les normes alimentaires pour des Poulets en bonne santé ... <br>
                    un véterinaire  spécialisé vache indique soigneusement les éléments nutritifs dont les Poulets avons besoin</p>
                </div>
