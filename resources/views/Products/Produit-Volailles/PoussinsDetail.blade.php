    ...
    @foreach($produits as $produit)
        ...
        <div class="detail-product">
            ...
            <div class="detail">
                ...
                <div class="titre">
                    <h1>Alimentation des Poussins</h1>
                    <p>Alf Sahel Respecte Toutes les normes alimentaires pour des Poussins en bonne santé ... <br>
                    un véterinaire  spécialisé vache indique soigneusement les éléments nutritifs dont les Poussins avons besoin</p>
                </div>
