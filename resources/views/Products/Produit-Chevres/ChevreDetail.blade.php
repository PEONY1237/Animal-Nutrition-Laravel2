    ...
    @foreach($produits as $produit)
        ...
        <div class="detail-product">
            ...
            <div class="detail">
                ...
                <div class="titre">
                    <h1>Alimentation des Chèvres</h1>
                    <p>Alf Sahel Respecte Toutes les normes alimentaires pour des Chèvres en bonne santé ... <br>
                    un véterinaire  spécialisé vache indique soigneusement les éléments nutritifs dont les Chèvres avons besoin</p>
                </div>
