...
@section('animal' , 'Chats' )

@section('content')

    @foreach($produits as $produit)
        @if($produit->Nom_Produit === 'Produit Chats')
        <div class="detail-product">

            <div class="detail">

                <div class="titre">
                    <h1>Alimentation des <br>Chats</h1>
                    <p>Alf Sahel Respecte Toutes les normes alimentaires pour des Chats en bonne santé ... <br>
                    un véterinaire  spécialisé vache indique soigneusement les éléments nutritifs dont les Chats avons besoin</p>
                </div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    <td>1.6</td>
                                    <td>40</td>
                                    <td rowspan="5"><img src="{{ url('/img/cat.png') }}"></td>
                                </tr>
                                <tr>
                                    <td>1.7</td>
                                    <td>50</td>
